...
NSString *const kIFTabbarHotnewsColor    = @"dd4348";
NSString *const kIFTabbarLatestnewsColor = @"93c867";
NSString *const kIFTabbarColumnColor     = @"00afca";
NSString *const kIFTabbarThemesColor     = @"fcd20a";
NSString *const kIFTabbarHistoryColor    = @"d28f5b";
